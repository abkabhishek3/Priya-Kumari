      ...
      <Container>
        <Row>
          <Col md={8} className="home-about-description">
            ...
            I've developed a strong passion for programming and gained significant knowledge in the field, affirming my substantial progress
              <br />
              <br />I possess proficiency in foundational technologies, including
              <i>
                <b className="purple"> HTML5, CSS3, JavaScript, Java. </b>
              </i>
              <br />
              <br />
              I love creating cutting-edge &nbsp;
              <i>
              ...
              <br />
              <br />
              I have a strong interest in using <b className="purple">Node.js</b> 
              <i>
                <b className="purple">
                  {" "}
                </b>
              </i>
              &nbsp; and contemporary JavaScript libraries and frameworks such as 
              <i>
